...
assert_block "$HOOK_R" '{"tool_input": {"file_path": "/home/j4c0b1/.ssh/id_rsa"}}' "Read SSH key"
assert_block "$HOOK_R" '{"tool_input": {"file_path": "/home/j4c0b1/.aws/credentials"}}' "Read AWS credentials"
