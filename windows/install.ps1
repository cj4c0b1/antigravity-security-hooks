...
$HooksDir = "$HOME\.antigravity\hooks"
...
Write-Host "`nTo enable these hooks, add the following to your Antigravity configuration"
Write-Host "→ Step 3: Add hooks to your ~/.antigravity/settings.json"
